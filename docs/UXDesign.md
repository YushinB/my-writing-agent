...
4. [Page Designs](#page-designs)
   ...
   - [Dictionary (Future)](#4-dictionary-future)
...
│  │  │  │✒️│  (Logo + Text)     │                           │  Theme Settings Dict  Logout   │ │  │
│  │  │  └──┘                    │                           └────────────────────────────────┘ │  │
│  │  └─────────────────────────┘                                                              │  │
│  └───────────────────────────────────────────────────────────────────────────────────────────┘  │
│                                                                                                  │
...
Quick reference tool for saving and looking up words, definitions, and usage examples.
...
```mermaid
graph TD
    A[Click Dictionary Icon] --> B[Dictionary Sidebar Opens]
    B --> C{User Action?}
